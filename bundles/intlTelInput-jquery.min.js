...
! function(a) {
    ...
    for (var h = [
            ...
            ["Kazakhstan (РљР°Р·Р°С…СЃС‚Р°РЅ)", "kz", "7", 1],
            ["Kenya", "ke", "254"],
            ["Kiribati", "ki", "686"],
            ["Kosovo", "xk", "383"],
            ...
            ["Vanuatu", "vu", "678"],
            ["Vatican City (CittГ  del Vaticano)", "va", "39", 1],
            ["Venezuela", "ve", "58"],
            ["Vietnam (Viб»‡t Nam)", "vn", "84"],
            ["Wallis and Futuna (Wallis-et-Futuna)", "wf", "681"],
            ["Western Sahara (вЂ«Ш§Щ„ШµШ­Ш±Ш§ШЎ Ш§Щ„ШєШ±ШЁЩЉШ©вЂ¬вЂЋ)", "eh", "212", 1],
            ["Yemen (вЂ«Ш§Щ„ЩЉЩ…Щ†вЂ¬вЂЋ)", "ye", "967"],
            ["Zambia", "zm", "260"],
            ["Zimbabwe", "zw", "263"],
            ["Г…land Islands", "ax", "358", 1]
        ], i = 0; i < h.length; i++) {
        var j = h[i];
        h[i] = {
            name: j[0],
        ...
        p = function() {
            ...
            return g(a, [{
                ...
                value: function() {
                    var a = this;
                    this._a5 = function(b) {
                        a.a === c.activeElement || a.a.value || (b.preventDefault(), a.a.focus())
                    }, this.a.addEventListener("mousedown", this._a5), this._a6 = function(b) {
                        "+" === b.key && (a.a.value = "")
                    }, this._a7 = function() {
                        a.a.value || a.a.readOnly || !a.s.dialCode || (a.a.value = "+".concat(a.s.dialCode), a.a.addEventListener("keypress", a._a6), setTimeout(function() {
                ...
                value: function() {
                    ...
                    var d = "",
                        e = null;
                    this._a3 = function(b) {
                        b.preventDefault(), "ArrowUp" === b.key || "ArrowDown" === b.key ? a._q(b.key) : "Enter" === b.key ? a._r() : "Escape" === b.key ? a._2() : /^[a-zA-ZГЂ-Гї ]$/.test(b.key) && (e && clearTimeout(e), d += b.key.toLowerCase(), a._s(d), e = setTimeout(function() {
                            d = ""
                        }, 1e3))
                ...
                value: function(a) {
                    ...
                    if (this.selectedFlag.setAttribute("title", c), this.d.separateDialCode) {
                        var d = this.s.dialCode ? "+".concat(this.s.dialCode) : "",
                            e = this.a.parentNode;
                        b.dialCode && e.classList.remove("iti-sdc-".concat(b.dialCode.length + 1)), d && e.classList.add("iti-sdc-".concat(d.length)), this.t.innerHTML = d
                    }
                    if (this._0(), this.d.allowDropdown) {
                        var f = this.b;
                        if (f && (f.classList.remove("active"), f.setAttribute("aria-selected", "false")), a) {
                            var g = this.m.querySelector("#iti-item-".concat(a));
                            g.setAttribute("aria-selected", "true"), g.classList.add("active"), this.b = g, this.m.setAttribute("aria-activedescendant", g.getAttribute("id"))
                        }
                    }
                    return b.iso2 !== a
                }
                ...
                value: function() {
                    ...
                    this.hiddenInput && a && a.removeEventListener("submit", this._a14), this.d.autoHideDialCode && (this.a.removeEventListener("mousedown", this._a5), this.a.removeEventListener("focus", this._a7), a && a.removeEventListener("submit", this._a8), this.a.removeEventListener("blur", this._a8)), this.a.removeEventListener("keyup", this._a12), this.a.removeEventListener("cut", this._a13), this.a.removeEventListener("paste", this._a13);
    ...
    b.intlTelInputGlobals.loadUtils = function(a) {
        ...
        return null
    }, b.intlTelInputGlobals.defaults = l, b.intlTelInputGlobals.version = "14.0.8";
